...
const organization = () => {
  ...
  const handleOrg = async () => {
    ...
    if (!orgName || !phoneNumber || !email || !district || !link) {
    ...
    try {
      ...
      const response = await axios.post(
        'http://192.168.215.52:5000/api/organization',
        {
          ...
          email: email,
          district: district,
          social_media_link: link, // Include social media link in the request
      ...
      if (response.status === 201) {
        ...
        setDistrict('');
        setLink('');
        router.push('/home'); // Navigate to the organization list page
      } else {
    ...
    <ScreenWrapper>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inp}>
            <Text style={styles.text}>Social Media or Website Link</Text>
            <Input placeholder='Social Media or Website Link' value={link} onChangeText={setLink} />
          </View>
